...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Administrator - Create Request Form</title>
		<meta name="description" content="Administrator - Create Request Form" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="{{url('/')}}">
				<img alt="Logo" width="80" style="position: relative;left: 35px;" class="img-logo-custom img-fluid" src="{{asset('assets/logo_transparant.png')}}" />
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="{{route('home')}}" class="brand-logo">
							<img alt="Logo" width="180" class="img-logo-custom img-fluid" src="{{asset('assets/logo_transparant.png')}}" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								@include('layouts.menu.opr')
								@include('layouts.menu.qa')
								@include('layouts.menu.itsecruity')
							</ul>
							<!--end::Menu Nav-->
						</div>
						<!--end::Menu Container-->
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right" style="">
										...
										<ul class="navi navi-hover py-4">
											@php
												$notifications = App\Models\Notification::where('is_role', Auth::user()->is_role)
                                                    ->latest()->paginate(4);
											@endphp
                                            ...
                                            <li class="text-center border-top pt-3">
                                                <a href="{{ route('notification.index') }}" class="d-block">See All</a>
                                            </li>
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="{{url('/')}}" target="_blank" class="text-dark-75 text-hover-primary">Connection Request Form - BTN</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->

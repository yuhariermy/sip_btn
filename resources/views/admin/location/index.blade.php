@extends('layouts.app')
@section('title')
    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Daftar Location</h5>
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        <li class="breadcrumb-item">
            <a href="{{route('location.index')}}" class="text-muted">Daftar Location</a>
        </li>
    </ul>
@endsection
@section('content')
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Daftar Location</h3>
                </div>
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{route('location.create')}}" class="btn btn-primary font-weight-bolder">
        ...
        $(document).ready(function () {
            ...
            $(document).ready(function () {
                ...
                $('body').on('click', '.btnDelete', function (e) {
                    ...
                    Swal.fire({
                        title: "Anda Yakin?",
                        text: "Ingin hapus data Location ?",
                        icon: "warning",

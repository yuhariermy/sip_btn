...
@section('title')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        <li class="breadcrumb-item">
            <a href="{{route('location.index')}}">Daftar Location</a>
        </li>
        <li class="breadcrumb-item">
            <a href="{{route('location.create')}}" class="text-muted">Tambah Location</a>
        </li>
        <li class="breadcrumb-item">
            <a href="#" class="text-muted">Ubah Location</a>
        </li>
    </ul>
@endsection
@section('content')
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Ubah Location</h3>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Nama Location
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" placeholder="Masukkan Nama Location" value="{{ old('name', $location->name) }}" name="name">
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-footer">
                <a href="{{route('location.index')}}" class="btn btn-default float-left">Cancel</a>
